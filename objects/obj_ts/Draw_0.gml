draw_sprite(lowres_sprite, -1, x, y);
...
if (global.inspection_mode == "magnifying")
{
	...
	if (global.magnifying)
	{
		...
		draw_sprite_part(rust_hires_sprite, -1, tmp_x - magn_center_margins + strop_2 , tmp_y + strop_2 - magn_center_margins , wasr, wasr, mouse_x - sadf , mouse_y -sadf);
		draw_sprite_part(rust_hires_sprite, -1, tmp_x + strop , tmp_y + strop_2 , magn_size/2 - sadf , magn_size_center, mouse_x - magn_size / 2, mouse_y - magn_size_center / 2);
		draw_sprite_part(rust_hires_sprite, -1, tmp_x+ border_size +sadf, tmp_y + strop_2, magn_size / 2 - sadf, magn_size_center, mouse_x + sadf, mouse_y - magn_size_center / 2);
		draw_sprite_part(rust_hires_sprite, -1, tmp_x + strop_2, tmp_y  + strop, magn_size_center , magn_size / 2 - sadf, mouse_x - magn_size_center / 2, mouse_y - magn_size / 2);
		draw_sprite_part(rust_hires_sprite, -1, tmp_x + strop_2, tmp_y  + border_size + sadf, magn_size_center, magn_size / 2 - sadf, mouse_x - magn_size_center / 2, mouse_y + sadf );
