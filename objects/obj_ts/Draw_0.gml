...
if (global.inspection_mode == "magnifying")
{
	...
	if (global.magnifying)
	{
		...
		dust_hires_mask = sprite_create_from_surface(dust_hires_surf, 0, 0, 85, 64, false, false, 0, 0);
		...
		draw_sprite_part(dust_hires_sprite, -1, tmp_x - magn_size_center / 2 + border_size - (magn_size - magn_size_center) / 2, tmp_y  - magn_size_center / 2 + border_size, (magn_size - magn_size_center) / 2, magn_size_center, mouse_x - magn_size_center / 2 - (magn_size - magn_size_center) / 2, mouse_y - magn_size_center / 2);
		draw_sprite_part(dust_hires_sprite, -1, tmp_x- magn_size_center / 2 + border_size + magn_size_center, tmp_y  - magn_size_center / 2 + border_size, (magn_size - magn_size_center) / 2, magn_size_center, mouse_x - magn_size_center / 2 + magn_size_center, mouse_y - magn_size_center / 2);
		draw_sprite_part(dust_hires_sprite, -1, tmp_x - magn_size_center / 2 + border_size, tmp_y  - magn_size_center / 2 + border_size - (magn_size - magn_size_center) / 2, magn_size_center, (magn_size - magn_size_center) / 2, mouse_x - magn_size_center / 2, mouse_y - magn_size_center / 2 - (magn_size - magn_size_center) / 2);
		draw_sprite_part(dust_hires_sprite, -1, tmp_x - magn_size_center / 2 + border_size, tmp_y  - magn_size_center / 2 + border_size + magn_size_center, magn_size_center, (magn_size - magn_size_center) / 2, mouse_x - magn_size_center / 2, mouse_y - magn_size_center / 2 + magn_size_center);
	}
}